...
namespace SMS.Common
{
    public class DateToAge
    {
        ...
        public DateToAge(DateTime Bday)
        {
            this.Count(Bday);
        }

        public DateToAge(DateTime Bday, DateTime Cday)
        {
            this.Count(Bday, Cday);
        }

        public DateToAge Count(DateTime Bday)
        {
            return this.Count(Bday, DateTime.Today);
        }

        public DateToAge Count(DateTime Bday, DateTime Cday)
        {
