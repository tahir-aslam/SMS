...
namespace SMS
{
    ...
    {         
        public static string con_string = "Server=" + MainWindow.Server + "; port=" + MainWindow.Port + "; Database=" + MainWindow.Database + "; Uid=" + MainWindow.Uid + "; Pwd=7120020@123; SslMode=Preferred; default command timeout=99999;CHARSET=utf8";
